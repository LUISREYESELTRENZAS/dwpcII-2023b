...
const UserSchema = new Schema(
  {
    ...
    // Agrega una propiedad que identifica el rol del usuario como user o admin     role: {       type: String,       enum: ['user', 'admin'],       message: '{VALUE} no es un rol valido',       default: 'user',     },
